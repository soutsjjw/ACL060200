...
class _AnimationWrapperState extends State<_AnimationWrapper>
  ...
  @override
  Widget build(BuildContext context) {
    Matrix4 rotateMatrix = Matrix4.identity()..rotateZ(_rotateAnim.value);
    Matrix4 transMatrix = Matrix4.identity()..translate(0.0, _transAnim.value, 0.0);
    Matrix4 combineMatrix = transMatrix * rotateMatrix;
